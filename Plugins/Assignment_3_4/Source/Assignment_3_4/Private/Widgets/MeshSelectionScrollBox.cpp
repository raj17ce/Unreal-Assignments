...
void UMeshSelectionScrollBox::PopulateTitleTextBox() {
	...
	UObject* MontserratFontObj = StaticLoadObject(UFont::StaticClass(), NULL, TEXT("/Script/Engine.Font'/Assignment_3_4/Fonts/Montserrat-Bold_Font.Montserrat-Bold_Font'"));
